...
from sparow.ph.ph_mpisppy import ProgressiveHedgingSolver_MPISPPY   # import parallel PH solver (mpi-sppy wrapper)
...
solver = ProgressiveHedgingSolver_MPISPPY() # solving in parallel with the sparow wrapper around mpisppy
solver.set_options(
